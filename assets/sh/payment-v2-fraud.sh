...
min_cc=1 # credit card skip number
max_cc=2500 # credit card skip number
min_tx=1  #min transaction per day
max_tx=4  #max transaction per day
min_minutes=60 # min qtd between transaction (1min)
max_minutes=300 # max qtd between transaction (5min)
min_amount=20 # min amount transaction
max_amount=800 # max amount transaction
min_term=1
max_term=300
var_fraud=1 # NO FRAUD
fraud_rate=3 # NO FRAUD RATE
